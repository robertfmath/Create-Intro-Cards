...
`create-intro-cards` is a Python module that transforms a dataset of individuals' names, photos, and custom attributes into a paginated PDF of "intro cards" that describe each individual. Each intro card displays a person's name, a photo, and a series of attributes based on custom columns in the dataset.
